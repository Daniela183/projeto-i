...
function Saudacao() {
    ...
    const gifs = [
        { id: 1, src: Oig, expectedText: "Oi" },
        { id: 2, src: BomDiag, expectedText: "Bom dia" },
        { id: 3, src: BoaTardeg, expectedText: "Boa tarde" },
        { id: 4, src: BoaNoiteg, expectedText: "Boa noite" },
        { id: 5, src: Tchaug, expectedText: "Tchau" },
    ];
