...
import Segunda from "../../img/gif/segunda.gif"
import Terca from "../../img/gif/terca.gif"
import Quarta from "../../img/gif/quarta.gif"
import Quinta from "../../img/gif/quinta.gif"
import Sexta from "../../img/gif/sexta 2.gif"
import Sabado from "../../img/gif/sabado.gif"
import Domingo from "../../img/gif/domingo.gif"
...
function Calendario() {
    ...
    const gifs = [
        { id: 1, src: Segunda, expectedText: "Segunda" },
        { id: 2, src: Terca, expectedText: "Terca" },
        { id: 3, src: Quarta, expectedText: "Quarta" },
        { id: 4, src: Quinta, expectedText: "Quinta" },
        { id: 5, src: Sexta, expectedText: "Sexta" },
        { id: 6, src: Sabado, expectedText: "Sabado" },
        { id: 7, src: Domingo, expectedText: "Domingo" },
    ];
