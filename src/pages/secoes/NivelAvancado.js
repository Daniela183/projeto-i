        ...
        <Box style={{ display: 'flex', justifyContent: 'center', backgroundColor: '	#aee2ff', minHeight: '100vh' }}>
            ...
            <Box style={{display:'flex', flexDirection: 'column'}}>
                <Box style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '10px', margin: '15px'}}>
                    <img onClick={() => handleClick('/saudacoes-avancado')} style={{ width: '30vh', height: '30vh', marginBottom: '15px' }} src={Saudacao} />
                
                    <img onClick={() => handleClick('/familia-avancado')} style={{ width: '30vh', height: '30vh', marginBottom: '15px' }} src={Familia}/>
                </Box>
            </Box>
            <Box style={{display:'flex', flexDirection: 'column'}}>
                <Box style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '10px', margin: '15px' , rowGap: '8px' }}>
                    <img onClick={() => handleClick('/calendario-avancado')} style={{ width: '30vh', height: '30vh', marginBottom: '15px' }} src={Calendar} />
                
                    <img onClick={() => handleClick('/cor-avancado')} style={{ width: '30vh', height: '30vh', marginBottom: '15px' }} src={Cor} />
                </Box>
            </Box>
